...
static int rp1_aout_platform_remove(struct platform_device *pdev)
{
...
static void rp1_aout_platform_shutdown(struct platform_device *pdev)
{
	rp1_aout_platform_remove(pdev);
}
...
static struct platform_driver rp1_audio_out_driver = {
	...
	.shutdown = rp1_aout_platform_shutdown,
	.driver = {
		.name = "rp1-audio-out",
